...
// These are the 2 different kind of request:
// - One that gets the infromation of the given pet, passing an URL parameter to our endpoint, wich at the same time are reading from the URL in our front-end app
// - The other request is to delete the given pet from our register. The difference here is once we confirm that the request was successful, I redirect the user to the root of our app
