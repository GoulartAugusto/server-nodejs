...
// This behaves very similar to the AddPet.jsx file

// The difference is that our pet info are initialized with the values of the pet we want to edit.

// When those values are updated by the user, we contruct an object that will be our request body and send the request with the updated info.